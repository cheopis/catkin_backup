...
bool operator==(const ::rt_gene::MSG_SubjectImages_<ContainerAllocator1> & lhs, const ::rt_gene::MSG_SubjectImages_<ContainerAllocator2> & rhs)
{
  return lhs.subject_id == rhs.subject_id &&
    lhs.face_img == rhs.face_img &&
    lhs.right_eye_img == rhs.right_eye_img &&
    lhs.left_eye_img == rhs.left_eye_img;
}
