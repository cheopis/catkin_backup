...
if("TRUE" STREQUAL "TRUE")
  set(rt_gene_SOURCE_PREFIX /home/ariele/catkin_ws/src/rt_gene/rt_gene)
  set(rt_gene_DEVEL_PREFIX /home/ariele/catkin_ws/devel)
  set(rt_gene_INSTALL_PREFIX "")
  set(rt_gene_PREFIX ${rt_gene_DEVEL_PREFIX})
else()
  set(rt_gene_SOURCE_PREFIX "")
  set(rt_gene_DEVEL_PREFIX "")
  set(rt_gene_INSTALL_PREFIX /home/ariele/catkin_ws/install)
...
if(NOT "/home/ariele/catkin_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rt_gene' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ariele/catkin_ws/src/rt_gene/rt_gene/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT rt_gene_NUM_DUMMY_TARGETS)
      set(rt_gene_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::rt_gene::wrapped-linker-option${rt_gene_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR rt_gene_NUM_DUMMY_TARGETS "${rt_gene_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::rt_gene::wrapped-linker-option${rt_gene_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND rt_gene_LIBRARIES "${interface_target_name}")
...
set(depends "rospy;std_msgs;geometry_msgs;sensor_msgs;image_geometry;cv_bridge;image_transport;tf;tf2_ros;message_runtime")
